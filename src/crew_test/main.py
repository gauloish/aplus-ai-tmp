...
def run():
    ...
    inputs = {
        ...
        'question': '''
            Na imagem vemos um certo ângulo, quanto mede o ângulo complementar ao da imagem?
        ''',
        'correct_answer': '''
        ''',
    ...
    inputs['image_description'] = image_reader.kickoff(inputs={"image_url": "https://res.cloudinary.com/dzgzxcisn/image/upload/v1739191832/questions/angulo.png"}).raw
